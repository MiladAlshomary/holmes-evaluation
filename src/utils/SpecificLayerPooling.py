...
class SpecificLayerPooling(nn.Module):
    ...
    def __init__(self,
        ...
        super(SpecificLayerPooling, self).__init__()
    ...
    def forward(self, features: Dict[str, Tensor]):
        ...
        for layer in self.layers:
            ...
            token_embeddings = all_layer_embedding[layer, :, :, :]
            features["token_layer_embeddings"][layer] = token_embeddings
            ...
            features["sentence_layer_embeddings"][layer] = output_vector
        return features
